...
class ViewsData {
  ...
  public function getViewsData() {
    ...
    $data['workbench_revision_tracker']['forward_revision'] = [
      'title' => $this->t('Forward Revision'),
      'help' => $this->t('A boolean indicating whether the entity has a forward revision.'),
      'field' => [
        'id' => 'forward_revision',
      ],
      'filter' => [
    ...
    $data['workbench_revision_tracker']['forward_revision_state'] = [
      'title' => $this->t('Forward Revision State'),
      'help' => $this->t('The moderation state of the forward revision.'),
      'field' => [
        'id' => 'forward_revision_state',
      ],
      'filter' => [
        'id' => 'string',
      ],
