...
namespace Drupal\shp_tilepage\Plugin\Derivative;
 ...
 */
class CustomContentTranslationLocalTasks extends ContentTranslationLocalTasks implements ContainerDeriverInterface {
  ...
  public function getDerivativeDefinitions($base_plugin_definition) {
    ...
    foreach ($this->contentTranslationManager->getSupportedEntityTypes() as $entity_type_id => $entity_type) {
      ...
      $translation_route_name = "entity.$entity_type_id.custom_content_translation_overview";
